...
import subscriptionStore from '@baserow/modules/core/store/subscriptions'
...
export default (context, inject) => {
  ...
  registry.registerNamespace('subscriptions')
  ...
  store.registerModule('subscriptions', subscriptionStore)
