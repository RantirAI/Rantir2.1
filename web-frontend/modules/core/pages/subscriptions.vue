  ...
  <div class="ra-main">
      <div class="ra-header-container">
          ...
          <div class="ra-buttons-container">
              ...
              <div class="ra-button-container">
                  <button class="ra-invoice-button">
                      <svg class="ra-invoice-icon" width="20" height="20" viewBox="0 0 24 24" fill="none">
                          <path d="M8 7L16 7M8 12L16 12M8 17L12 17" stroke="currentColor" stroke-width="2"
              ...
              <!-- View Issues Button -->
              <a href="/projects/qOCYXm38zKgAdsxblisdv/issues">
                  <button class="ra-nav-button">
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                          <g clip-path="url(#clip0_893_11129)">
                              <path
                                  d="M9 16.5C13.1421 16.5 16.5 13.1421 16.5 9C16.5 4.85786 13.1421 1.5 9 1.5C4.85786 1.5 1.5 4.85786 1.5 9C1.5 13.1421 4.85786 16.5 9 16.5Z"
                                  stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M9 6V9" stroke="black" stroke-width="1.5" stroke-linecap="round"
                                  stroke-linejoin="round" />
                              <path d="M9 12H9.00777" stroke="black" stroke-width="1.5" stroke-linecap="round"
                                  stroke-linejoin="round" />
                          </g>
                          <defs>
                              <clipPath id="clip0_893_11129">
          ...
          <div class="ra-new-flow-section">
              <a href="/projects/qOCYXm38zKgAdsxblisdv/flows">
                  <button class="ra-new-flow-button">
                      New User Group
                  </button>
              </a>
          </div>
      ...
      <div class="modal__wrapper">
          <div class="modal__box">
              ...
              <div class="modal__actions"><a class="modal__close"><i class="iconoir-cancel"></i></a> </div>
          </div>
      </div>
  </div>
</template>
