<template>
    <div class="modal__wrapper">
        <template v-if="isOpenNewPlanModal">
            <NewPlanModal @close="isOpenNewPlanModal = false" />
        </template>
        <div v-else class="modal__box">
            <h2 class="box__title">
